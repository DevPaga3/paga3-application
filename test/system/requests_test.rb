...
class RequestsTest < ApplicationSystemTestCase
  ...
  test "creating a Request" do
    ...
    fill_in "Cell phone", with: @request.cell_phone
    fill_in "Email", with: @request.email
    fill_in "Price", with: @request.price
    fill_in "Product", with: @request.product
    fill_in "Profile", with: @request.profile_id
    fill_in "Render number", with: @request.render_number
    fill_in "Status", with: @request.status
    fill_in "Store", with: @request.store
